...
public class RadioButtonPage extends ElementsPage {
  ...
  public static By YES_BUTTON = css("label[for='yesRadio']");
  public static By NO_BUTTON; //= css("label[for='noRadio']")
  public static By IMPRESSIVE_BUTTON = css("label[for='impressiveRadio']");
