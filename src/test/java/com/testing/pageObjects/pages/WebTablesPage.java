...
public class WebTablesPage extends ElementsPage {
  ...
  public static By AGE_FIELD  = css("input[placeholder='Age']");;
  public static By SALARY_FIELD  = css("input[placeholder='Salary']");
  public static By DEPARTMENT_FIELD  = css("input[placeholder='Department']");
  // Search field on the right side;
  public static By SEARCH_FIELD  = css("input[placeholder='Type to search']");
